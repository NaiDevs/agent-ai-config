# Projects Registry
<!-- Edita este archivo para agregar, renombrar o eliminar aliases/workspaces -->
<!-- Base path por defecto: C:\Users\{username}\OneDrive\Documentos\Proyectos -->
<!-- Después de editar, haz commit y push para sincronizar en otros dispositivos -->
...
## CORINSA | C:\Users\naide\OneDrive\Documentos\Proyectos
...
| Alias        | Carpeta                       | Stack      | Descripción      |
|--------------|-------------------------------|------------|------------------|
| ult fe       | UltimateLabs                  | Node/TS    | Frontend         |
| ult api      | UltimateLabsApiGit            | C#/.NET    | API              |
| ult bo       | UltimateLabsBackoffice        | Node/TS    | Backoffice       |
| ult bo git   | UltimateLabsBackofficeGit     | Node/TS    | Backoffice (git) |
| ult ecom api | UltimateLabsECommerceAPI      | C#/.NET    | E-commerce API   |
| ult ecom     | UltimateLabsEcommerceGit      | Node/TS    | E-commerce FE    |

## EMSULA DOCTOR | C:\Users\naide\OneDrive\Documentos\Proyectos\EMSULA DOCTOR

| Alias      | Carpeta       | Stack      | Descripción     |
|------------|---------------|------------|-----------------|
| doctor fe  | CITDoctor     | Angular/TS | Frontend médico |
| doctor api | CITDoctorAPI  | C#/.NET    | API médica      |

## NAI (personal) | C:\Users\naide\OneDrive\Documentos\Proyectos\Nai

| Alias              | Carpeta                  | Stack      | Descripción          |
|--------------------|--------------------------|------------|----------------------|
| nai inhands bo     | inHandsBackOffice        | Node/TS    | Backoffice inHands   |
| nai inhands api    | inHandsBackOfficeApi     | C#/.NET    | API inHands          |
| nai restaurant api | inHandsRestauranteApi    | Node/TS    | API restaurante      |
| nai dash           | nai-dashboard-components | Node/TS    | Dashboard components |
| nai dash comp      | dashboards-components    | Node/TS    | Lib componentes      |
| nai spectral       | spetralview-sdk          | Node/TS    | SDK Spectral         |
| nai media          | mediaPlayer              | Node/TS    | Media player         |
