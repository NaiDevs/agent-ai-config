...
- [Sync catálogos SPC/Delasa → YALO](project-spc-delasa-sync.md) — fx-sync-info (Lambda upsert genérico) + spc-delasa (orquestador); clientes/vendedores/pagos/categoría/territorio hechos; PENDIENTE productos/precios + impuestos + bodegas/inventario (2026-08-11) + bloqueantes (cód AUTH org, establecimiento, deploy, verificar nombres SPC)
